...
writer = SummaryWriter(comment=f'maml_ppo_test')
...
while step_i < max_n_steps:
    ...
    if step_i % n_steps_eval == 0: 
        ...
        for task_idx in task_ids: 
            ...
            reward_step0.append(total_reward_step0)
            reward_step1.append(total_reward_step1)

        writer.add_scalar('tasks/mean_rstep0', onp.mean(reward_step0), step_i)
        writer.add_scalar('tasks/mean_rstep1', onp.mean(reward_step1), step_i)
